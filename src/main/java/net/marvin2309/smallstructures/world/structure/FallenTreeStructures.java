...
public class FallenTreeStructures extends StructureFeature<JigsawConfiguration> {
    ...
    public FallenTreeStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, FallenTreeStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (FallenTreeStructures.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            SmallStructures.LOGGER.log(Level.DEBUG, "Sky Structures at {}", blockpos);
        }
